...
export default function WalletTransactionLedger() {
  ...
  // Group transactions by "Today", "Yesterday", "Older"
  ...
  return (
    <div className="min-h-screen bg-surface text-on-surface flex flex-col pt-safe pb-safe relative">
      <header className="fixed top-0 w-full z-50 bg-surface/90 backdrop-blur-xl pt-safe">
        <div className="flex items-center justify-between h-14 px-margin">
          <div className="flex items-center gap-space-sm">
            ...
            <h1 className="font-headline-sm text-headline-sm font-bold text-on-surface truncate">Ledger &amp; Wallet</h1>
          </div>
      ...
      <nav className="fixed bottom-0 w-full z-50 pb-safe bg-surface/90 backdrop-blur-xl shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
        <div className="flex justify-around items-center h-16 px-space-xs">
          {[
            ...
            { icon: 'shield_with_heart', label: 'Credit', path: '/finance/credit-insurance' },
            { icon: 'account_balance_wallet', label: 'Wallet', path: '/finance/wallet', active: true },
